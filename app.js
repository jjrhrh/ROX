...
const srvs = isAnime ? [
  { icon:'🎌', name:'PRIME',    desc:'رئيسي', url:`${S.ANIME}${id}/${season}/${episode}`,          active:true },
  { icon:'⚡', name:'NEXUS',    desc:'بديل',  url:`${S.ANIME2}${id}/${season}/${episode}`          },
  { icon:'💎', name:'TITAN',    desc:'بديل',  url:`${S.ANIME3}${id}/${season}/${episode}`          },
  { icon:'🌌', name:'COSMOS',   desc:'بديل',  url:`${S.ANIME4}${id}/${season}/${episode}`          },
  { icon:'👑', name:'ZENITH',   desc:'بديل',  url:`${S.ANIME5}${id}/${season}/${episode}`          },
  { icon:'🌅', name:'AURORA',   desc:'بديل',  url:`${S.ANIME6}${id}/${season}/${episode}`          },
  { icon:'⭐', name:'STELLAR',  desc:'بديل',  url:`${S.ANIME7}${id}/${season}/${episode}`          },
  { icon:'🔮', name:'PHANTOM',  desc:'بديل',  url:`${S.ANIME8}${id}/${season}/${episode}`          },
  { icon:'🌙', name:'ECLIPSE',  desc:'بديل',  url:`${S.ANIME9}${id}/${season}/${episode}`          },
  { icon:'✨', name:'NOVA',     desc:'بديل',  url:`${S.ANIME10}${id}/${season}/${episode}`         },
  { icon:'🔵', name:'CRYSTAL',  desc:'بديل',  url:`${S.ANIME11}${id}&s=${season}&e=${episode}`     },
  { icon:'🟣', name:'CIPHER',   desc:'بديل',  url:`${S.ANIME12}${id}/${season}/${episode}`         },
  { icon:'🎯', name:'ORION',    desc:'بديل',  url:`${S.ANIME13}${id}/${season}/${episode}`         },
  { icon:'💫', name:'NEBULA',   desc:'بديل',  url:`${S.ANIME14}${id}/${season}/${episode}`         },
  { icon:'🖤', name:'ONYX',     desc:'بديل',  url:`${S.ANIME15}${id}/${season}/${episode}`         },
  { icon:'🌟', name:'VEGA',     desc:'بديل',  url:`${S.ANIME16}${id}/${season}/${episode}`         },
] : type === 'tv' ? [
  { icon:'📺', name:'PRIME',    desc:'رئيسي', url:`${S.TV}${id}/${season}/${episode}`,             active:true },
  { icon:'⚡', name:'NEXUS',    desc:'بديل',  url:`${S.TV2}${id}/${season}/${episode}`             },
  { icon:'💎', name:'TITAN',    desc:'بديل',  url:`${S.TV3}${id}/${season}/${episode}`             },
  { icon:'🌅', name:'AURORA',   desc:'بديل',  url:`${S.TV4}${id}/${season}/${episode}`             },
  { icon:'🌌', name:'COSMOS',   desc:'بديل',  url:`${S.TV5}${id}/${season}/${episode}`             },
  { icon:'👑', name:'ZENITH',   desc:'بديل',  url:`${S.TV6}${id}/${season}/${episode}`             },
  { icon:'⭐', name:'STELLAR',  desc:'بديل',  url:`${S.TV7}${id}/${season}/${episode}`             },
  { icon:'🔮', name:'PHANTOM',  desc:'بديل',  url:`${S.TV8}${id}/${season}/${episode}`             },
  { icon:'🌙', name:'ECLIPSE',  desc:'بديل',  url:`${S.TV9}${id}/${season}/${episode}`             },
  { icon:'✨', name:'NOVA',     desc:'بديل',  url:`${S.TV10}${id}/${season}/${episode}`            },
  { icon:'🌟', name:'VEGA',     desc:'بديل',  url:`${S.TV11}${id}/${season}/${episode}`            },
  { icon:'🔵', name:'CRYSTAL',  desc:'بديل',  url:`${S.TV12}${id}&s=${season}&e=${episode}`        },
  { icon:'🟣', name:'CIPHER',   desc:'بديل',  url:`${S.TV13}${id}/${season}/${episode}`            },
  { icon:'🎯', name:'ORION',    desc:'بديل',  url:`${S.TV14}${id}/${season}/${episode}`            },
  { icon:'💫', name:'NEBULA',   desc:'بديل',  url:`${S.TV15}${id}/${season}/${episode}`            },
  { icon:'🖤', name:'ONYX',     desc:'بديل',  url:`${S.TV16}${id}/${season}/${episode}`            },
  { icon:'🏆', name:'APEX',     desc:'بديل',  url:`${S.TV17}${id}/${season}/${episode}`            },
  { icon:'🎬', name:'NEXUS+',   desc:'بديل',  url:`${S.TV18}${id}&season=${season}&episode=${episode}` },
] : [
  { icon:'🎬', name:'PRIME',    desc:'رئيسي', url:`${S.MOV}${id}`,          active:true },
  { icon:'⚡', name:'NEXUS',    desc:'بديل',  url:`${S.MOV2}${id}`          },
  { icon:'💎', name:'TITAN',    desc:'بديل',  url:`${S.MOV3}${id}`          },
  { icon:'🌅', name:'AURORA',   desc:'بديل',  url:`${S.MOV4}${id}`          },
  { icon:'🌌', name:'COSMOS',   desc:'بديل',  url:`${S.MOV5}${id}`          },
  { icon:'👑', name:'ZENITH',   desc:'بديل',  url:`${S.MOV6}${id}`          },
  { icon:'⭐', name:'STELLAR',  desc:'بديل',  url:`${S.MOV7}${id}`          },
  { icon:'🔮', name:'PHANTOM',  desc:'بديل',  url:`${S.MOV8}${id}&tmdb=1`   },
  { icon:'🌙', name:'ECLIPSE',  desc:'بديل',  url:`${S.MOV9}${id}`          },
  { icon:'✨', name:'NOVA',     desc:'بديل',  url:`${S.MOV10}${id}`         },
  { icon:'🌟', name:'VEGA',     desc:'بديل',  url:`${S.MOV11}${id}`         },
  { icon:'💫', name:'NEBULA',   desc:'بديل',  url:`${S.MOV12}${id}`         },
  { icon:'🏆', name:'APEX',     desc:'بديل',  url:`${S.MOV13}${id}`         },
  { icon:'🟣', name:'CIPHER',   desc:'بديل',  url:`${S.MOV14}${id}`         },
  { icon:'🎯', name:'ORION',    desc:'بديل',  url:`${S.MOV15}${id}`         },
  { icon:'🔵', name:'CRYSTAL',  desc:'بديل',  url:`${S.MOV16}${id}`         },
  { icon:'🖤', name:'ONYX',     desc:'بديل',  url:`${S.MOV17}${id}`         },
  { icon:'🌈', name:'PRISM',    desc:'بديل',  url:`${S.MOV18}${id}`         },
];
