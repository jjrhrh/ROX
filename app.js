...
const srvs = isAnime ? [
  ...
  { icon:'🌐', name:'Anime 8',  desc:'بديل',  url:`${S.ANIME8}${id}/${season}/${episode}`        },
  { icon:'🎥', name:'Anime 9',  desc:'بديل',  url:`${S.ANIME9}${id}/${season}/${episode}`        },
  { icon:'💫', name:'Anime 10', desc:'بديل',  url:`${S.ANIME10}${id}/${season}/${episode}`       },
  { icon:'🔵', name:'Anime 11', desc:'بديل',  url:`${S.ANIME11}${id}&s=${season}&e=${episode}`   },
  { icon:'🟣', name:'Anime 12', desc:'بديل',  url:`${S.ANIME12}${id}/${season}/${episode}`       },
] : type === 'tv' ? [
  ...
  { icon:'🌐', name:'TV 9',  desc:'بديل',  url:`${S.TV9}${id}/${season}/${episode}`        },
  { icon:'🎥', name:'TV 10', desc:'بديل',  url:`${S.TV10}${id}/${season}/${episode}`       },
  { icon:'💫', name:'TV 11', desc:'بديل',  url:`${S.TV11}${id}/${season}/${episode}`       },
  { icon:'🔵', name:'TV 12', desc:'بديل',  url:`${S.TV12}${id}&s=${season}&e=${episode}`   },
  { icon:'🟣', name:'TV 13', desc:'بديل',  url:`${S.TV13}${id}/${season}/${episode}`       },
] : [
  ...
  { icon:'🌐', name:'فيلم 10', desc:'بديل',  url:`${S.MOV10}${id}`       },
  { icon:'🎥', name:'فيلم 11', desc:'بديل',  url:`${S.MOV11}${id}`       },
  { icon:'💫', name:'فيلم 12', desc:'بديل',  url:`${S.MOV12}${id}`       },
  { icon:'🔵', name:'فيلم 13', desc:'بديل',  url:`${S.MOV13}${id}`       },
  { icon:'🟣', name:'فيلم 14', desc:'بديل',  url:`${S.MOV14}${id}`       },
];
